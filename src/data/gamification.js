...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    desc: "Correct in <8s",
    icon: "\u26A1",
    cond: (s) => s.fastCorrect >= 1,
  },
  {
    id: "ten",
    name: "Scholar",
    desc: "50 correct in total",
    icon: "\uD83D\uDCDA",
    cond: (s) => s.correct >= 50,
  },
  {
  ...
  },
  {
    ...
    desc: "200 correct",
    icon: "\uD83D\uDC51",
    cond: (s) => s.correct >= 200,
  },
  {
    id: "hard5",
    name: "Hard Master",
    desc: "5 hard questions correct",
    icon: "\uD83C\uDFC6",
    cond: (s) => s.hardCorrect >= 5,
  },
  {
    id: "jackpot",
    name: "Jackpot!",
  ...
  },
  {
    id: "topics",
    name: "Polymath",
    desc: "Score in 10+ topics",
    icon: "\uD83E\uDDE0",
    cond: (s) => s.topicsOk >= 10,
  },
  {
    id: "collector",
    name: "Collector",
    desc: "Open 5 chests",
    icon: "\uD83D\uDCE6",
    cond: (s) => s.chestsOpened >= 5,
  },
  {
    id: "scratch",
    name: "Scratcher",
    desc: "Use 3 scratch cards",
    icon: "\uD83C\uDF9F\uFE0F",
    cond: (s) => s.scratchUsed >= 3,
  },
  {
    id: "powerup",
    name: "Power User",
    ...
    icon: "\uD83E\uDDEA",
    cond: (s) => s.powerupsUsed >= 3,
  },
  {
    id: "boss_win",
    name: "Boss Slayer",
    desc: "Win a boss battle",
    icon: "\uD83D\uDC09",
    cond: (s) => s.bossWins >= 1,
  },
  {
  ...
  },
  {
    id: "boss15",
    name: "Dragonbane",
    desc: "Win 15 boss battles",
    icon: "\uD83D\uDDE1\uFE0F",
    cond: (s) => s.bossWins >= 15,
  },
  {
    id: "boss_t3",
    name: "Wyrm Slayer",
    desc: "Defeat a tier 3+ dragon",
    icon: "\uD83D\uDD25",
    cond: (s) => s.highestTierDefeated >= 3,
  },
  {
    id: "boss_t5",
    name: "Colossus Killer",
    desc: "Defeat the Certified Colossus",
    icon: "\uD83D\uDC80",
    cond: (s) => s.highestTierDefeated >= 5,
  },
  {
    id: "boss_dmg",
    name: "1000 Damage",
    desc: "Deal 1000 total damage",
    icon: "\uD83D\uDCA5",
    cond: (s) => s.totalBossDmgDealt >= 1000,
  },
  {
    id: "boss_flawless",
    name: "Flawless",
    desc: "Win without missing a question",
    icon: "\u2728",
    cond: (s) => s.flawlessBossWin,
  },
  {
    id: "tier2",
    name: "Silver Era",
  ...
  // no tener ningun dominio flojo, no solo una media alta.
  {
    id: "domain_master",
    name: "Full Spectrum",
    desc: `${DOMAIN_MASTERY_PERCENT}% or higher accuracy in every domain`,
    icon: "\uD83C\uDF10",
    secret: true,
    cond: (s) => s.allDomainsMastered,
  },
  ...
  // fijo, asi que salta en la misma actualizacion que cierra la coleccion.
  {
    ...
    icon: "\uD83D\uDC8E",
    platinum: true,
    cond: (s) => REGULAR_ACHIEVEMENT_IDS.every((id) => s.unlocked.includes(id)),
  },
];

// Todos menos el platino: es lo que hay que completar para conseguirlo.
export const REGULAR_ACHIEVEMENT_IDS = ACHIEVEMENTS.filter(
  (achievement) => !achievement.platinum,
...
export const WHEEL_SEGMENTS = [
  ...
  { label: "\uD83C\uDF9F\uFE0F Scratch", scratch: true, color: "#d4930a", w: 10 },
  { label: "\uD83D\uDCE6 Chest", chest: true, color: "#b37a08", w: 8 },
...
export const CHEST_ITEMS = [
  ...
  {
    name: "Streak Shield",
    desc: "Protects your streak once",
    icon: "\uD83D\uDEE1\uFE0F",
    freeze: true,
    rarity: "rare",
  },
  {
    name: "Double Down",
    desc: "x2 on your next 3 correct answers",
    icon: "\u26A1",
    multDuration: 3,
    rarity: "rare",
  },
...
export const POWERUPS = [
  { id: "5050", name: "50/50", desc: "Removes 2 options", icon: "\u2702\uFE0F", uses: 1 },
  { id: "hint", name: "Hint", desc: "Shows an extra hint", icon: "\uD83D\uDCA1", uses: 1 },
  {
    id: "shield",
    name: "Shield",
    desc: "Keep your streak if you miss",
    icon: "\uD83D\uDEE1\uFE0F",
    uses: 1,
  },
  { id: "double", name: "Double XP", desc: "x2 XP on this question", icon: "\u26A1", uses: 1 },
];
