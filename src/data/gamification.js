...
export const ACHIEVEMENTS = [
  {
    id: "first_blood",
    name: "First Blood",
    desc: "Acierta tu primera pregunta",
    icon: "\uD83C\uDFAF",
    cond: (s) => s.correct >= 1,
  },
  {
  ...
  },
  {
    ...
    desc: "Derrota al Certified Colossus",
    icon: "\uD83D\uDC80",
  ...
  },
  {
    id: "boss_dmg",
    name: "1000 Damage",
    desc: "Inflige 1000 de dano total",
    icon: "\uD83D\uDCA5",
  ...
  },
  {
    id: "boss_flawless",
    name: "Flawless",
    desc: "Gana sin fallar una pregunta",
    icon: "\u2728",
  ...
  // no tener ningun dominio flojo, no solo una media alta.
  {
    id: "domain_master",
    name: "Full Spectrum",
    desc: `${DOMAIN_MASTERY_PERCENT}% o mas de acierto en todos los dominios`,
    icon: "\uD83C\uDF10",
    secret: true,
  ...
  // fijo, asi que salta en la misma actualizacion que cierra la coleccion.
  {
    id: "platinum",
    name: "Platinum",
    desc: "Consigue todos los demas logros",
    icon: "\uD83D\uDC8E",
    platinum: true,
...
export const POWERUPS = [
  ...
  { id: "hint", name: "Hint", desc: "Muestra pista extra", icon: "\uD83D\uDCA1", uses: 1 },
  {
    id: "shield",
    name: "Shield",
    desc: "No pierdes racha si fallas",
    icon: "\uD83D\uDEE1\uFE0F",
    uses: 1,
  },
