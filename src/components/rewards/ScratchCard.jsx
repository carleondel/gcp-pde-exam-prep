...
export function ScratchCard({ onComplete, onClose }) {
  ...
  useEffect(() => {
    ...
    g.addColorStop(0, "#3d4556");
    g.addColorStop(0.5, "#8b95a8");
    g.addColorStop(1, "#3d4556");
    ctx.fillStyle = g;
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 20, fontWeight: 800, color: rarityColors[prize.rarity] }}>
              {prize.label}
            </div>
            <div
              style={{
          ...
          <div style={{ animation: "pulse 0.5s" }}>
            <div
              style={{
                fontSize: 15,
                fontWeight: 700,
                color: rarityColors[prize.rarity],
                marginBottom: 12,
              }}
            >
              {prize.xp
