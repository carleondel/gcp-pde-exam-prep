...
export function MysteryChest({ onComplete, onClose }) {
  ...
  const rarityBg = {
    common: "var(--signal-info)",
    rare: "var(--primary-400)",
    epic: "var(--highlight)",
    legendary: "var(--accent-300)",
  };
  const rarityGlow = {
    common: "rgba(74,158,255,0.22)",
    rare: "rgba(15,191,163,0.26)",
    epic: "rgba(143,255,106,0.24)",
    legendary: "rgba(255,183,51,0.3)",
  };
          ...
          <div style={{ animation: "chestOpen 0.8s ease" }}>
            ...
            <div
              style={{
                ...
                justifyContent: "center",
                fontSize: 72,
                background: `radial-gradient(circle,${rarityBg[item.rarity]}33,transparent)`,
                boxShadow: `0 0 60px ${rarityGlow[item.rarity]}`,
                border: `3px solid ${rarityBg[item.rarity]}`,
              }}
            >
              {item.icon}
            </div>
            ...
            <button
              ...
              style={{
                padding: "12px 40px",
                background: `linear-gradient(135deg,${rarityBg[item.rarity]},${rarityBg[item.rarity]}cc)`,
                border: "none",
                borderRadius: "var(--radius-md)",
                color: "white",
                fontSize: 15,
